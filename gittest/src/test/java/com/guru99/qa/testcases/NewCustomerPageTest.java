...
public class NewCustomerPageTest extends TestBase {
	...
	@Test(dataProvider = "NewcustomerExcel", dataProviderClass = DataProviders.class)
	public void CreateNewCustomerTest(String customerName, String gender, String dateofbirth, String address,
		...
		Newcustomer.CreateNewCustomer(customerName, gender, dateofbirth, address, city, state, pin, mobilenumber, email,
				password);
	}
